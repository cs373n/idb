...
def main():
    ...
    try:
	    ...
	    newComic = Comic(id=428, title="Ant-Man (2003) #4", issue=4, desc="This is a test description", upc="12345", pg_ct=0, price=2.99, img="http://i.annihil.us/u/prod/marvel/i/mg/4/20/4bc697c680890.jpg", num_creators=2, num_characters=0, num_events=0)
